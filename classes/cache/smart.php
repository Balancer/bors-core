...
class cache_smart extends cache_base
{
	...
	function get($type, $key, $uri='', $default=NULL)
	{
		...
		$dbh = new driver_mysql(\B2\Cfg::get('cache_database'));
	...
	{
//		if(\B2\Cfg::get('is_debug')) echo "set($value, $time_to_expire, $infinite)<br/>";

//		echo "cd = ".\B2\Cfg::get('cache_disabled')."<br/>";
		if(\B2\Cfg::get('cache_disabled'))
