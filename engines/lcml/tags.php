...
//var_dump($res);
	...
	if($params)
	{
		$skip_list = " {$skip_list} align _align_b _align_e alt colspan name notitle orig rowspan skip_around_cr title valign _border url uri border width xwidth _width self skip_around_cr";
		$att = array();
